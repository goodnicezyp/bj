    ...
    <form onsubmit="return false;" class="form form-horizontal" id="cateAdd">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" placeholder="类别代码请严格参照上述代码，如：文字类，此处填写101" id="projectFileType" name="projectFileType">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">类别名称：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" placeholder="类别名称" id="name" name="name">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">作品编码前缀：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" placeholder="用于作品编码的前缀" id="prefix" name="prefix">
            </div>
        </div>
        <div class="row cl">
...
<script type="text/javascript">
    $("#cateAdd").validate({
        ...
        submitHandler:function(form){
            ...
            postData("addCate",data,function (res) {
                if(res.status == "1"){
