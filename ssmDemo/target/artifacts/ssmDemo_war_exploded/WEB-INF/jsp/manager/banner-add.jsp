    ...
    <form onsubmit="return false;" class="form form-horizontal" id="permissionAdd">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" placeholder="图片名称" id="title" name="title">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">外部链接：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input id="link" name="link" type="text" class="input-text" placeholder="跳转H5链接，非本域名必须要在小程序后台配置安全域名">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">小程序链接：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input id="pagePath" name="pagePath" type="text" class="input-text" placeholder="跳转小程序的页面链接，是以pages/xxx开头，此地址需要询问小程序开发人员">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <span class="select-box">
                    <select class="select" size="1" name="demo1" id="typeOptions">
                        ...
                        <option value="2">最新活动banner</option>
                    </select>
                </span>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $("#permissionAdd").validate({
        ...
        submitHandler:function(form){
            ...
            postData("addBanner",data,function (res) {
                if(res.status == "1"){
