				...
				<form onsubmit="return false;" class="form form-horizontal" id="form-member-add">
					<div class="row clearfix">
						...
						<div class="form-controls col-xs-8 col-sm-9">
							<input type="text" class="input-text" value="${diskSpace.title}" placeholder="套餐名称" id="title" name="title">
						</div>
					</div>
					<div class="row clearfix">
						<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>套餐价格：</label>
						<div class="form-controls col-xs-8 col-sm-9">
							<input type="text" class="input-text" autocomplete="off" value="${diskSpace.price}" placeholder="套餐价格" id="price" name="price">
						</div>
					</div>
					<div class="row clearfix">
						<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>空间大小(kb)：</label>
						<div class="form-controls col-xs-8 col-sm-9">
							<input type="text" class="input-text" autocomplete="off" value="${diskSpace.sizeNum}" placeholder="空间大小，请输入以kb为单位的数字" id="sizeNum" name="sizeNum">
						</div>
					</div>
		...
		$(function(){
			...
			$("#form-member-add").validate({
				...
				submitHandler:function(form){
                    ...
                    postData("updateDiskSpace",data,function (res) {
                        if(res.status == "1"){
