				...
				<div class="panel-body">
					<form class="form form-horizontal" id="form-article-add">
						...
						<div class="row clearfix">
							...
							<div class="form-controls col-xs-8 col-sm-9">
								<input type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss' })" name="createTime" id="createTime" class="input-text Wdate createTime" style="width:200px;">
							</div>
						</div>
						<div class="row clearfix">
							...
							<div class="form-controls col-xs-8 col-sm-9">
								<span class="select-box">
									<select name="typeOption" class="select" id="typeOptions">
										<option value="0">最新版权法规</option>
										<option value="1">最新活动</option>
										<option value="2">最新行业动态</option>
										<option value="3">最新维权案例</option>
									</select>
								</span>
							</div>
						</div>
		...
		$(function(){
			...
			$("#form-article-add").validate({
				...
				submitHandler: function(form){
                    ...
                    postData("addArticle",data,function (res) {
                        if(res.status == "1"){
