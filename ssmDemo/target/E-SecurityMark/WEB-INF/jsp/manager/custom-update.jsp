    ...
    <form onsubmit="return false;" class="form form-horizontal" id="permissionAdd">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" value="${custom.userPhone}" class="input-text" placeholder="联系方式" id="userPhone" name="userPhone">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <div class="z_photo upimg-div clear proDetail" style="border: 2px dashed #E7E6E6; width: 160px;padding: 3px;">
                    <div id="preview" style="width: 160px;height: 150px;">
                        <img id="imgProDetail0" name="imgProDetail0" border="0" src="<c:choose><c:when test="${empty custom.userImg}">../../../statics/img/a11.png</c:when><c:otherwise>${custom.userImg}</c:otherwise></c:choose>" width="160" height="150" onclick="$('#previewImg').click();">
                    </div>
...
<script type="text/javascript">
    $("#permissionAdd").validate({
        ...
        submitHandler:function(form){
            ...
            postData("updateCustom",data,function (res) {
                if(res.status == "1"){
