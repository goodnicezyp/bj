...
<body>
		...
		<article class="Hui-admin-content clearfix">
			<div class="panel">
				<div class="panel-body">
					<div class="text-c">
						<input type="text" class="input-text" style="width:250px" placeholder=" 输入用户昵称" id="searchVal" name="" onfocus="this.select()" onKeyPress="JumpByEnter()">
			...
			<div class="panel mt-20">
				<div class="panel-body">
					<div class="clearfix mt-20">
						<table id="agreeRecordTable" class="table table-border table-bordered table-hover table-bg table-sort">
							<thead>
								<tr class="text-c">
	...
	<script type="text/javascript">
        $(document).ready(function() {
            ...
            //添加、修改异步提交地址
            var url = "agreeRecordList";

            agreeRecordTable=$("#agreeRecordTable").DataTable({
                ...
                columnDefs: [
                    ...
                    { targets:4,render:function (val) {
                        if(val == 3){
                            return "<span class='label radius'>上传作品承诺及著作权授权书</span>";
                        }else if (val == 4) {
                            return "<span class='label radius'>作品下载授权协议</span>";
                        } else if (val == 8) {
                            return "<span class='label radius'>备案须知</span>";
                        } else if (val == 9) {
                            return "<span class='label radius'>提现协议</span>";
                        }else{
                            return "<span class='label radius'>认证协议</span>";
                        }
                    }},
            ...
            //表格选中行效果
            $('#agreeRecordTable tbody').on( 'click', 'tr', function (e) {
        ...
        $('#agreeRecordTable tbody').on('click', '.btn_check_user', function () {
            var row = agreeRecordTable.row($(this).closest('tr')).data(); //这个插件要取到值还真是只有这样的绑定事件才可以 原因不明
            var id = row.userid;
