				...
				<form onsubmit="return false;" class="form form-horizontal" id="form-member-add">
					<div class="row clearfix">
						...
						<div class="form-controls col-xs-8 col-sm-9">
							<input type="text" class="input-text" value="" placeholder="代金券名称" id="title" name="title">
						</div>
					</div>
					<div class="row clearfix">
						<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>优惠金额：</label>
						<div class="form-controls col-xs-8 col-sm-9">
							<input type="text" class="input-text" autocomplete="off" value="" placeholder="优惠金额" id="price" name="price">
						</div>
					</div>
					<div class="row clearfix">
						...
						<div class="form-controls col-xs-8 col-sm-9">
							<span class="select-box" style="width:150px;">
								<select class="select" name="type" size="1" id="type">
									<option value="0">平台代金券</option>
									<option value="1">线下维权代金券</option>
								</select>
							</span>
						</div>
					</div>
						...
						<div class="form-controls col-xs-8 col-sm-9">
							<span class="select-box" style="width:150px;">
								<select class="select" name="type" size="1" id="date_flag">
									...
									<option value="1">统一限时</option>
									<option value="2">获得限时</option>
								</select>
							</span>
						</div>
					</div>
					...
					<div class="time" style="display: none;">
						<div class="row cl">
							...
							<div class="formControls col-xs-8 col-sm-2">
								<input type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm' })" id="logmin" class="input-text Wdate datetimeStart" style="width:150px;">
							</div>
						</div>
						<div class="row cl">
							<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>截止时间：</label>
							<div class="formControls col-xs-8 col-sm-2">
								<input type="text" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'logmin\')}',dateFmt:'yyyy-MM-dd HH:mm' })" id="logmax" class="input-text Wdate datetimeEnd" style="width:150px;">
							</div>
						</div>
					</div>
					...
					<div class="day" style="display: none;">
						<div class="row cl">
							...
							<div class="formControls col-xs-8 col-sm-9">
								<input id="day_num" class="proNum input-text" placeholder="领到券后N天内有效" type="text">
							</div>
						</div>
					</div>
...
//					}
                    ...
                    postData("addCoupon",data,function (res) {
                        if(res.status == "1"){
